...
public class Pattern_and_Matcher_class {
    public static void main(String[] args) {
        String text = "Key takeaways to strengthen reasoning\n" + //
                        "Linear in x or y ⇒ average also over also an interval equals midpoint of endpoint values.\n" + //
                        "\n" + //
                        "Plane = a + b x + c y ⇒ average also over rectangle equals value at the center.\n" + //
                        "\n" + //
                        "For rectangles and planes, you can also average the four corners.\n" + //
                        "\n" + //
